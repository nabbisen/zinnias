import { DESCRIBE_RESPONSE_TOKEN_MAX_NUMBER, MATH_PROMPT_RESPONSE_FORMAT, MATH_PROMPT_START } from "$lib/constants/api/math-guide"
...
export function describePrompt(question: string, generateTone: GenerateTone): Part[] {
    const prompt: Part[] = [
        ...
        { text: `【問題文】${question}` },
        { text: `【回答書式】${MATH_PROMPT_RESPONSE_FORMAT} ${responseTokenMaxNumberPrompt(DESCRIBE_RESPONSE_TOKEN_MAX_NUMBER)}` },
